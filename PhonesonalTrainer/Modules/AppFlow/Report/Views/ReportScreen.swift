        ...
        VStack {
            ...
            case .diet:
                VStack(spacing: 16) {
                    ...
                    DietGoalStampCard(
                        achievedDays: viewModel.dietAchievedDays
                    )
                    .frame(maxWidth: maxWidthWithPadding)
                }
            }
...
// MARK: - ReportScreenContent (NavigationStack 없이 콘텐츠만)
struct ReportScreenContent: View {
...
struct ReportScreen_Previews: PreviewProvider {
    static var previews: some View {
        ReportScreen(viewModel: ReportViewModel.preview)
    }
}
